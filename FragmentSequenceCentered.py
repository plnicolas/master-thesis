...
class FragmentSequenceCentered(keras.utils.Sequence):
    """
    ...
    def __init__(self, setInput, setOutput, batchSize, widthImage, heightImage, prefixPath, reductionOperation):
        """
        ...
        self.reductionOperation = reductionOperation
    ...
    def __getitem__(self, index):
        ...
        while i < len(batchInputReturned):
            ...
            if self.reductionOperation == "crop":
            ...
            elif self.reductionOperation == "resize":
                picture1 = skimage.transform.resize(picture1, (self.heightImage, self.widthImage))
                picture2 = skimage.transform.resize(picture2, (self.heightImage, self.widthImage))
            
            else:
                raise ArgumentException("The argument REDUCTION_OPERATION_TEST_SET is invalid.")
