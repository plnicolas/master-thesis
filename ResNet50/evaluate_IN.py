...
if __name__ == "__main__":
    ...
    PREFIX_RESULTS = "/home/plnicolas/codes/Results/Evaluation/ResNet/IN/"

    if not os.path.exists(PREFIX_RESULTS):
        os.makedirs(PREFIX_RESULTS)

    import tensorflow as tf
    model = keras.models.load_model('/scratch/users/plnicolas/trainedmodels/resnet_IN.h5', custom_objects={"tf": tf})
