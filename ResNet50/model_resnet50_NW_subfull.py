...
if __name__ == "__main__":
    ...
    PREFIX_RESULTS = "/home/plnicolas/codes/Results/ResNet50/FullRandom/"
    ADDITIONAL_INFORMATION = "ResNet50 with no weight initialization and subfull. All weights are directly trainable. The loss function is the categorical cross-entropy. The optimizer is Adam with the default beta1 and beta2 parameters."
